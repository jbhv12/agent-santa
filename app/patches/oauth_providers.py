...
class CognitoOAuthProvider(OAuthProvider):
    id = "cognito"
    env = ["COGNITO_CLIENT_ID", "COGNITO_CLIENT_SECRET", "COGNITO_DOMAIN", "COGNITO_REDIRECT_URI"]
    ...
    def __init__(self):
        ...
        self.authorize_url = f"https://{self.domain}/login"
        self.token_url = f"https://{self.domain}/oauth2/token"
        self.user_info_url = f"https://{self.domain}/oauth2/userInfo"
